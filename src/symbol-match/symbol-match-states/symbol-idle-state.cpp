...
//         std::bind(&SymbolIdle::onSymbolMatchCommandReceived, this, std::placeholders::_1, SerialIdentifier::OUTPUT_JACK),
//         SerialIdentifier::OUTPUT_JACK);
//     symbolWirelessManager->setPacketReceivedCallback(
//         std::bind(&SymbolIdle::onSymbolMatchCommandReceived, this, std::placeholders::_1, SerialIdentifier::INPUT_JACK),
...
// void SymbolIdle::onSymbolMatchCommandReceived(const SymbolMatchCommand& command, SerialIdentifier port) {
