...
CryptCreeper*  cryptCreeper    = nullptr;
...
void setup() {
    ...
    cryptCreeper = new CryptCreeper(CRYPT_CREEPER_APP_ID, fdn->getRemoteDeviceCoordinator(), controllerWirelessManager);
    ...
    AppConfig apps = {
        ...
        {StateId(CRYPT_CREEPER_APP_ID),  cryptCreeper},
    };
