...
QuickdrawDemo*  quickdrawDemo    = nullptr;
...
void setup() {
    ...
    quickdrawDemo = new QuickdrawDemo(QUICKDRAW_DEMO_APP_ID, fdn->getRemoteDeviceCoordinator(), controllerWirelessManager);
    ...
    AppConfig apps = {
        ...
        {StateId(QUICKDRAW_DEMO_APP_ID),  quickdrawDemo},
    };
