 ...
 *
 * onStatePaused: Invoked when this state is being paused (e.g., another app is launching).
 * Returns a Snapshot that can be used to restore state on resume.
 *
 * onStateResumed: Invoked when this state is being resumed after being paused.
 * Receives the Snapshot that was saved during pause.
 */
class State {
public:
    virtual ~State() {
