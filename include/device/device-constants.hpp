...
constexpr uint8_t RXr2 = 39; //TIP OF AUDIO CABLE
constexpr uint8_t RXt2 = 38; //MIDDLE BAND ON AUDIO CABLE
constexpr uint8_t recessLightsPin = 21;
constexpr uint8_t finLightsPin = 13;
