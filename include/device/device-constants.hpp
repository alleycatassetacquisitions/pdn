...
const uint8_t RXr = 41;
const uint8_t RXt = 40;
const uint8_t TXt = 39; //MIDDLE BAND ON AUDIO CABLE
const uint8_t TXr = 38; //TIP OF AUDIO CABLE
const uint8_t displayLightsPin = 13;
const uint8_t gripLightsPin = 21;
const uint8_t displayCS = 10;
const uint8_t displayDC = 9;
const uint8_t displayRST = 14;

const uint8_t VIBRATION_MAX = 255;
const uint8_t VIBRATION_OFF = 0;

const uint8_t BRIGHTNESS_MAX = 255;
const uint8_t BRIGHTNESS_OFF = 0;

const uint8_t numDisplayLights = 13;
const uint8_t numGripLights = 6;
...
const uint16_t TRANSMIT_QUEUE_MAX_SIZE = 1024;
